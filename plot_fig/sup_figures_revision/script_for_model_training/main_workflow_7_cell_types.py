...
if __name__ == '__main__':
    ...
    #                               'PRAD', 'THCA', 'UCEC']
    cancer_types_for_filtering = [i for i in cancer_types if i not in ['OV']]
    ...
    # cell_type2subtypes = {'CD4 T': ['CD4 T conv', 'CD4 Treg'], 'CD8 T': ['CD8 T (GZMK high)', 'CD8 T effector'],
    #                       'DC': ['mDC', 'pDC'], 'Cancer Cells': ['Cancer Cells'],
    #                       'Fibroblasts': ['Fibroblasts'], 'NK': ['NK'], 'Monocytes': ['Monocytes']}
    cell_type2subtypes = {'B Cells': ['B Cells'], 'CD4 T': ['CD4 T'], 'CD8 T': ['CD8 T'],
                          'Cancer Cells': ['Cancer Cells'], 'Fibroblasts': ['Fibroblasts'],
                          'Macrophages': ['Macrophages'], 'Endothelial Cells': ['Endothelial Cells']}
    ...
    simu_ds_dir = f'simulated_bulk_cell_{len(all_cell_types)}_cell_types'
    ...
    dataset2parameters = {
        ...
        #                       'test_set': True},
        # f'SCT_POS_N10K_{single_cancer_type}': {'n_each_cell_type': 10000, 'cell_type2subtype': cell_type2subtypes},

        f'Mixed_N100K_segment_without_filtering':
    ...
    merged_sc_dataset_file_path = os.path.join(deside_data_dir, 'single_cell',
                                               f'merged_12_sc_datasets_231003.h5ad')
    ...
    result_root_dir = os.path.join('results', f'whole_workflow_20240704_{len(all_cell_types)}_celltypes')
    ...
    sct_dataset_file_path = os.path.join(sc_dataset_dir,
                                         f'simu_bulk_exp_SCT_POS_N10K_log2cpm1p.h5ad')
    if debug:
    ...
    current_project_id = f'DeSide_{len(all_cell_types)}_cell_types'
