...
if __name__ == '__main__':
    ...
    simu_ds_dir = 'simulated_bulk_cell_only_luad_cancer_cells'
    ...
    dataset2parameters = {
        ...
        'SCT_POS_N100_test': {'n_each_cell_type': 100, 'cell_type2subtype': cell_type2subtypes,
                              'test_set': True},
        'SCT_POS_N10K_luad': {'n_each_cell_type': 10000, 'cell_type2subtype': cell_type2subtype_sct},

        'Mixed_N100K_segment_without_filtering_luad': {'sc_dataset_ids': sc_dataset_ids,
    ...
    merged_sc_dataset_file_path = os.path.join(deside_data_dir, 'single_cell',
                                               'merged_12_sc_ds_only_luad_cancer_cells.h5ad')
    ...
    result_root_dir = os.path.join('results', f'whole_workflow_20240519_{n_sc_datasets}ds_only_luad_cancer_cells')

    sc_dataset_dir = os.path.join(deside_data_dir,
                                  f'generated_sc_dataset_{n_sc_datasets}ds_n_base{n_base}_all_subtypes')
    sct_dataset_file_path = os.path.join(sc_dataset_dir, f'simu_bulk_exp_SCT_POS_N10K_luad_log2cpm1p.h5ad')
    if debug:
    ...
    # step1
    current_project_id = f'DeSide_03_new_ds_subtypes_all_range_softmax_no_pathway'
    ...
    deside_parameters = {'architecture': ([200, 2000, 2000, 2000, 50],
                         ...
                         'last_layer_activation': 'softmax',  # sigmoid / softmax
                         'learning_rate': 1e-4,
                         'batch_size': 128}
    ...
    training_set_list = [
        ...
        'Mixed_N100K_segment_without_filtering_luad',  # not filtered by both GEP-level and gene-level
