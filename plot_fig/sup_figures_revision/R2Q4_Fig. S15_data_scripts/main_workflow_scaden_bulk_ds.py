...
if __name__ == '__main__':
    ...
    result_root_dir = os.path.join('results', f'whole_workflow_20240517')
    ...
    # step1
    current_project_id = f'DeSide_01_scaden_ascites_ds_deside_model'
    ...
    train_ds2path = {'ascite_scaden': os.path.join(deside_data_dir, 'from_scaden', 'ascite_scaden_log2cpm1p.h5ad')}
